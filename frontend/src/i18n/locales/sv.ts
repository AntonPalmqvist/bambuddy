export default {
  ...
  nav: {
    ...
    system: 'System',
    collapseSidebar: 'Minimera sidomenyn',
    expandSidebar: 'Maximera sidomenyn',
    update: 'Uppdatera',
  ...
  printers: {
    ...
    maintenanceDue: '{{count}} förfallna',
    maintenanceDue_plural: '{{count}} förfallna',
    // Sort options
    sort: {
      name: 'Namn',
      status: 'Status',
    ...
    camWall: {
      page: {
        tokenRejected: 'Denna länk till kameraväggen är inte längre giltig. Token kan ha löpt ut eller återkallats.',
    ...
    powerOn: 'Sätt på',
    offlinePrintersWithPlugs: 'Offline-skrivare med smarta stickproppar',
    ...
    permission: {
      ...
      noSmartPlugControl: 'Du har inte behörighet att kontrollera smarta stickproppar',
  ...
  queue: {
    ...
    bulkEdit: {
      ...
      bedLevelling: 'Byggplattnivåinställning',
